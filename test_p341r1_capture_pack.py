...
def test_frozen_a3_identity_is_explicit_and_cross_archetype():
    ...
    assert FROZEN_MATERIALIZATION_METHOD == "REPOSITORY_SEALED_RECONTAINER_EXACT_MEMBER_SHA256"
    assert len(FROZEN_ARTIFACT_SHARDS) == 5
    assert all(path.startswith("benchmarks/frozen/p341/") for path in FROZEN_ARTIFACT_SHARDS)
    assert FROZEN_ORIGINAL_ARTIFACT_CONTAINER_SHA256 == "c3f737403a914fd5c3da4ff33ca8ef2d8d2378818fa566434d548cd7680542b9"
    assert FROZEN_REPOSITORY_CONTAINER_SHA256 == "607ebe5ad23b2997333dab33965aeb016c4980e8f7af223148f9aaee52539b9c"
